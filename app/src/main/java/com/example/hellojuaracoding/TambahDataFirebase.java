...
public class TambahDataFirebase extends AppCompatActivity {
    EditText txtNama;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calendarLahir.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView view, int year, int month, int dayOfMonth) {
                ...
                Toast.makeText(TambahDataFirebase.this,tanggal ,Toast.LENGTH_LONG).show();
            }
        });


        String dataJson = SharedPrefUtil.getInstance(TambahDataFirebase.this).getString("data_input");
...
//                      updateBiodata(generateObjectData());
    ...
    public void showErrorDialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(TambahDataFirebase.this);
        ...
        alertDialog.setMessage("Mohon isi field yang mandatory").setIcon(R.drawable.ic_close).setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(TambahDataFirebase.this,"Cancel ditekan",Toast.LENGTH_LONG).show();
            }
        });
    ...
    public static Intent getActIntent(Activity activity) {
        ...
        return new Intent(activity, TambahDataFirebase.class);
    }
}
